...
import { MOCK_USERS, USER, USER_VALIDATION } from './user.constant';
...
export class UserService {
  ...
  updateUser(
    ...
    if (userIndex === COMMON_CONST.NEGATIVE_ONE) {
      return throwError(() => DISPLAY_MESSAGE.RECORD_NOT_FOUND);
    }
  ...
  deleteUser(userId: number): Observable<boolean> {
    ...
    this.MOCK_USERS.splice(userIndex, COMMON_CONST.ONE);
    return of(true);
  }
}
